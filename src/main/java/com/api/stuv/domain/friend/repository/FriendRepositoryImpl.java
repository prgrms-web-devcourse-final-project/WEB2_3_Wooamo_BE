...
public class FriendRepositoryImpl implements FriendRepositoryCustom {
    ...
    @Override
    public PageResponse<FriendFollowRequestListResponse> getFriendFollowRequestList(Long receiverId, Pageable pageable, String imageUrl) {
        JPAQuery<FriendFollowRequestListResponse> query = jpaQueryFactory
                .select(Projections.constructor(FriendFollowRequestListResponse.class,
                        f.id.as("friendId"),
                        u.id.as("senderId"),
        ...
        return PageResponse.applyPage(query, pageable, getTotalFriendFollowRequestListPage(receiverId));
    }

    private Long getTotalFriendFollowRequestListPage(Long receiverId) {
